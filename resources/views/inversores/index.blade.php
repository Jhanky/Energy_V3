...
<script>
    function filterTable() {
        ...
        for (i = 0; i < tr.length; i++) {
            var tdMarca = tr[i].getElementsByTagName("td")[0]; // Columna de NIC
            var tdModelo = tr[i].getElementsByTagName("td")[1]; // Columna de Nombre
            var tdTipo = tr[i].getElementsByTagName("td")[2]; // Columna de Tipo de Cliente
            var tdTipoRed = tr[i].getElementsByTagName("td")[3]; // Columna de Ciudad
            var tdPotencia = tr[i].getElementsByTagName("td")[4]; // Columna de Consumo actual $/kWh

            if (tdMarca && tdModelo && tdTipo && tdTipoRed && tdPotencia) {
                ...
                var txtValuePotencia = tdPotencia.textContent || tdPotencia.innerText;
                ...
                if (txtValueMarca.toUpperCase().indexOf(filter) > -1 ||
                    ...
                    txtValuePotencia.toUpperCase().indexOf(filter) > -1) {
                    tr[i].style.display = "";
                } else {
