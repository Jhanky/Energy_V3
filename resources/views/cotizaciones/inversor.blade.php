        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="myForm" action="{{ route('cotizaciones.crear') }}" name="form-data" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="input-group input-group-outline my-3">
                                    <select id="tipo_sistema" name="tipo_sistema" class="form-control" onchange="checkTipoSistema(this)" required>
                                        <option disabled selected>Tipo de sistema</option>
                                        <option data-tipo="Off grid" value="Desconectado de la red">Desconectado de la red</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="input-group input-group-outline my-3">
                                    ...
                                    <input type="number" class="form-control" id="cantidad1" name="numero_paneles" required>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="input-group input-group-outline my-3">
                                    <select id="inversor" name="id_inversor" class="form-control select-a-filtrar" required>
                                        <option value="" disabled selected>Seleccionar Inversor</option>
                                        @foreach ($inversores as $inversor)
                                        <option value="{{ $inversor->id }}" data-tipo-red="{{ $inversor->tipo_red }}" data-poder="{{$inversor->poder}}" data-tipo="{{$inversor->tipo}}">
                            ...
                            <div class="col-md-4">
                                <div class="input-group input-group-outline my-3">
                                    ...
                                    <input type="number" id="cantidad2" name="numero_inversores" class="form-control" required>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="input-group input-group-outline my-3 focused is-focused">
                                    ...
                                    <input type="text" class="form-control custom-input" name="valor_tramites" required value="$7,000,000">
                                </div>
                            </div>
                            <div class="col-sm">
                                <div class="input-group input-group-outline my-3 focused is-focused">
                                    <label class="form-label">Mano de obra</label>
                                    <input type="text" class="form-control custom-input" name="mano_obra" required value="$200,000">
                                </div>
                            </div>
                            <div class="col-sm">
                                <div class="input-group input-group-outline my-3 focused is-focused">
                                    <label class="form-label">Estructura</label>
                                    <input type="text" class="form-control custom-input" name="valor_estructura" required value="$105,000">
                                </div>
                            </div>
                            <div class="col-sm">
                                <div class="input-group input-group-outline my-3 focused is-focused">
                                    <label class="form-label">Material E.</label>
                                    <input type="text" class="form-control custom-input" name="valor_material_electrico" required value="$180,000">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <div class="input-group input-group-outline my-3 focused is-focused">
                                    ...
                                    <input type="number" id="valor_gestion_comercial" name="valor_gestion_comercial" value="2" class="form-control custom-porcentaje" required value="2">
                                </div>
                                <div class="input-group input-group-outline my-3 focused is-focused">
                                    <label class="form-label">Administración</label>
                                    <input type="number" id="valor_administracion" name="valor_administracion" class="form-control custom-porcentaje" required value="8">
                                </div>
                            </div>
                            <div class="col-sm">
                                <div class="input-group input-group-outline my-3 focused is-focused">
                                    <label class="form-label">Imprevistos</label>
                                    <input type="number" id="valor_imprevisto" name="valor_imprevisto" class="form-control custom-porcentaje" required value="2">
                                </div>
                                <div class="input-group input-group-outline my-3 focused is-focused">
                                    <label class="form-label">Utilidad</label>
                                    <input type="number" id="valor_utilidad" name="valor_utilidad" class="form-control custom-porcentaje" required value="5">
                                </div>
                            </div>
                            <div class="col-sm">
                                <div class="input-group input-group-outline my-3 focused is-focused">
                                    <label class="form-label">Retención</label>
                                    <input type="number" id="valor_retencion" name="valor_retencion" class="form-control custom-porcentaje" required value="3.5">
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filtrarInversores() {
                ...
                var tipoSistemaSeleccionado = tipoSistemaSelect.options[tipoSistemaSelect.selectedIndex].getAttribute('data-tipo');
