        ...
        <div class="card my-4">
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <form method="POST" action="{{ route('data.export') }}" id="exportForm">
                        @csrf
                                    ...
                                    <td class="align-middle text-center">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li style="margin-left: 30px; margin-right: 30px">
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modal-notification-{{ $result->id }}">
...
<script>
    document.getElementById('exportButton').addEventListener('click', function() {
        if (validateSelection()) {
            ...
            // Mostrar el modal de advertencia si no hay selección
            new bootstrap.Modal(document.getElementById('modal-warning')).show();
        }
    });
...
<script>
    document.getElementById('exportButton').addEventListener('click', function() {
        ...
        if (checkboxes.length === 0) {
            ...
            let warningModal = new bootstrap.Modal(document.getElementById('modal-warning'));
            warningModal.show();
        } else {
            // Deshabilitar el botón para evitar múltiples envíos
            this.disabled = true;
            // Enviar el formulario si hay elementos seleccionados
            document.querySelector('form').submit();
        }
    });
</script>
