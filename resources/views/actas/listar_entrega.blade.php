            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div
                        ...
                        <h6 class="text-white text-capitalize ps-3 mb-0">Tabla de actas de entrega de proyecto</h6>
                        <div class="me-3">
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <li style="margin-left: 30px; margin-right: 30px">
                                                    <form action="{{ route('pdf.entrega', ['id' => $visita->id]) }}"
                                                ...
                                                <li style="margin-left: 30px; margin-right: 30px">
                                                    <form method="POST"
                                                        action="{{ route('visita.info', ['id' => $visita->id]) }}"
